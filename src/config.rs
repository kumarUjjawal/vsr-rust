...
pub const CLOCK_OFFSET_TOLERANT_MAX_MS: i32 = 10000;

pub const CLOCK_EPOCH_MAX_MS: i32 = 60000;

pub const CLOCK_SYNCHRONIZATION_WINDOWN_MIN_MS: i32 = 2000;

pub const CLOCK_SYNCHRONIZATION_WINDOWN_MAX_MS: i32 = 20000;
