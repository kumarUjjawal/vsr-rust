...
pub const CLOCK_OFFSET_TOLERANT_MAX_MS: u64 = 10000;

pub const CLOCK_EPOCH_MAX_MS: u64 = 60000;

pub const CLOCK_SYNCHRONIZATION_WINDOWN_MIN_MS: u64 = 2000;

pub const CLOCK_SYNCHRONIZATION_WINDOWN_MAX_MS: u64 = 20000;
